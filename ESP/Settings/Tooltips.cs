...
#nullable disable
  ...
  public static bool Drops => PermissionManager.IsFeatureEnabledByHash(PermissionHash.Drops, configDrops.Value);
  public static ConfigEntry<bool> configBreeding;
  public static bool Breeding => PermissionManager.IsFeatureEnabledByHash(PermissionHash.Breeding, configBreeding.Value);
  public static ConfigEntry<bool> configStatus;
  public static bool Status => PermissionManager.IsFeatureEnabledByHash(PermissionHash.Status, configStatus.Value);
  public static ConfigEntry<bool> configAttacks;
  public static bool Attacks => PermissionManager.IsFeatureEnabledByHash(PermissionHash.Attacks, configAttacks.Value);
  public static ConfigEntry<bool> configResistances;
  public static bool Resistances => PermissionManager.IsFeatureEnabledByHash(PermissionHash.Resistances, configResistances.Value);
  public static ConfigEntry<bool> configExtraInfo;
  public static bool ExtraInfo => PermissionManager.IsFeatureEnabledByHash(PermissionHash.ExtraInfo, configExtraInfo.Value);
  public static ConfigEntry<bool> configCustomOnly;
  public static bool CustomOnly => PermissionManager.IsFeatureEnabledByHash(PermissionHash.CustomOnly, configCustomOnly.Value);
  public static ConfigEntry<bool> configWeaponInfo;
  public static bool WeaponInfo => PermissionManager.IsFeatureEnabledByHash(PermissionHash.WeaponInfo, configWeaponInfo.Value);
  public static ConfigEntry<bool> configShowProgress;
  public static bool Progress => PermissionManager.IsFeatureEnabledByHash(PermissionHash.Progress, configShowProgress.Value);
  public static ConfigEntry<bool> configSupport;
  public static bool Support => PermissionManager.IsFeatureEnabledByHash(PermissionHash.Support, configSupport.Value);
  public static ConfigEntry<bool> configStructures;
  public static bool Structures => PermissionManager.IsFeatureEnabledByHash(PermissionHash.Structures, configStructures.Value);
  public static ConfigEntry<bool> configCreatures;
  public static bool Creatures => PermissionManager.IsFeatureEnabledByHash(PermissionHash.Creatures, configCreatures.Value);
  public static ConfigEntry<bool> configDestructibles;
  public static bool Destructibles => PermissionManager.IsFeatureEnabledByHash(PermissionHash.Destructibles, configDestructibles.Value);
  public static ConfigEntry<bool> configPickables;
  public static bool Pickables => PermissionManager.IsFeatureEnabledByHash(PermissionHash.Pickables, configPickables.Value);
  public static ConfigEntry<bool> configItemDrops;
  public static bool ItemDrops => PermissionManager.IsFeatureEnabledByHash(PermissionHash.ItemDrops, configItemDrops.Value);
  public static ConfigEntry<bool> configShowShipStats;
  public static bool ShowShipStats => PermissionManager.IsFeatureEnabledByHash(PermissionHash.ShowShipStats, configShowShipStats.Value);
  public static ConfigEntry<bool> configLocations;
  public static bool Locations => PermissionManager.IsFeatureEnabledByHash(PermissionHash.Locations, configLocations.Value);
  public static ConfigEntry<bool> configVegetation;
  public static bool Vegetation => PermissionManager.IsFeatureEnabledByHash(PermissionHash.Vegetation, configVegetation.Value);
