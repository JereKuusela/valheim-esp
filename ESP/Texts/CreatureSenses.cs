...
namespace ESP {
  public partial class Texts {
    private static string FireRange(BaseAI obj) {
      if (Settings.CreatureFireLineWidth == 0 || !Helper.IsValid(obj)) return "";
    ...
    private static string ViewRange(BaseAI obj) {
      if (Settings.SenseLineWidth == 0 || !Helper.IsValid(obj)) return "";
    ...
    private static string BreedingLimit(Procreation obj) {
      if (Settings.BreedingLineWidth == 0 || !Helper.IsValid(obj)) return "";
    ...
    private static string FoodLimit(MonsterAI obj) {
      if (Settings.BreedingLineWidth == 0 || !Helper.IsValid(obj) || obj.m_consumeItems.Count == 0) return "";
