...
namespace ESP
{
  public class Settings
  {
    ...
    public static void Init(ConfigFile config)
    {
      ...
      Settings.configCreatureRayWidth = config.Bind("Visual", "Creature rays", 0.25f, "Line width for tracked creature locations (0 to disable)");
      ...
      Settings.configSpawnSystemRayWidth = config.Bind("Visual", "Spawn zones", 0.5f, "Line width of spawn zone system (0 to disable)");
